...
class LoginHashesSessionGuard implements StatefulGuard, SupportsBasicAuth
{
    ...
    public function __construct($name,
        ...
        LoginHashesRepository $hashRepository,
    ...
    protected function getSessionId($name, $default = null)
    {
        $hash   = $this->session->get($name, $default);
    ...
    protected function getAppId()
    {
        ...
        return $this->app_id = $this->appRepository->loginHashesMyAppId();
    }
    ...
    public function user()
    {
        ...
        $id = $this->getSessionId($this->getName());
    ...
    protected function getHashUniqueKey()
    {
        ...
        return $this->new_hash = str_random(100);
    }
    ...
    public function id()
    {
        ...
        $id = $this->getSessionId($this->getName(), $this->getRecallerId());
    ...
    protected function getUserByRecaller($recaller)
    {
        if ($this->validRecaller($recaller) && !$this->tokenRetrievalAttempted) {
            ...
            list($hash, $token) = explode('|', $recaller, 2);

            $app_id = $this->getAppId();

            $id = $this->hashRepository->get($hash, $app_id);
    ...
    public function login(AuthenticatableContract $user, $remember = false)
    {
        ...
        $hash = $this->setHash($user);
        $this->updateSession($hash);
     ...
     * @return void
     */
    protected function updateSession($hash)
    {
        $this->session->set($this->getName(), $hash);
    ...
    {
        $hash  = $this->setHash($user);
        $value = $hash . '|' . $user->getRememberToken();
